...
class MetriqueContainer(MutableMapping):
    ...
    def __setitem__(self, key, value):
        ...
        self.store[o['_id']] = o
        # container contents have been modified; we'll
        # need to recache the schema
    ...
    def pop(self, key):
        ...
        # container contents have changed; need to recache schema
        self._schema_generated = False
        return value
    ...
    def schema(self):
        ...
        if not (self._schema_generated or schema) and self.store:
            ...
            values = self.values()
            schema = autoschema(values, exclude_keys=self.RESTRICTED_KEYS)
